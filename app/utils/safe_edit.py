...
async def safe_edit_text(
    ...
    **kwargs
    ...
    - InaccessibleMessage (сообщение стало недоступным)
    ...
    try:
        if isinstance(event, CallbackQuery):
            ...
            if isinstance(event.message, InaccessibleMessage):
                logger.warning(f"Сообщение callback недоступно, отправляем новое")
            ...
            if isinstance(event, InaccessibleMessage):
                logger.warning(f"Сообщение недоступно, отправляем новое")
                return False
...
async def safe_edit_callback_text(
    ...
    **kwargs
    ...
    """
    Безопасное редактирование текста сообщения из callback.
    
    Эта функция автоматически обрабатывает InaccessibleMessage,
    отправляя новое сообщение вместо редактирования.
    ...
    Returns:
        bool: True если успешно, False если ошибка
    """
    return await safe_edit_text(callback, text, reply_markup, parse_mode, **kwargs)
